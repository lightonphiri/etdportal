...
{   
    ...
    //chanal variables
    private String chanalTitle, chanalDescription;
     ...
     throws ServletException
    {
        ...
        {   
            ...
            //get the admin email===========================================
                ...
                NodeList repoList = root.getElementsByTagName("chanalName");
                Element repoElement = (Element)repoList.item(0);
                NodeList textRepoList = repoElement.getChildNodes();
                chanalTitle = ((Node)textRepoList.item(0)).getNodeValue().trim();
                ...
                NodeList urlList = repoDescElement.getElementsByTagName("webSiteURL");
                Element urlElement = (Element)urlList.item(0);
                NodeList textUrlElement = urlElement.getChildNodes();
                webSiteURL = ((Node)textUrlElement.item(0)).getNodeValue().trim();
                
                //get the text element of description
                NodeList textList = repoDescElement.getElementsByTagName("textDescription");
                Element textElement = (Element)textList.item(0);
                NodeList stringTextElement = textElement.getChildNodes();
                chanalDescription = ((Node)stringTextElement.item(0)).getNodeValue().trim();
    ...
    @Override
     public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException
     {
        ...
        if(!configFileError)
        {
            ...
            finalResponse.append("      <title>"+chanalTitle+"</title>\n");
            finalResponse.append("      <link>"+webSiteURL+"</link>\n");
            finalResponse.append("      <description>"+chanalDescription+"</description>\n");
            finalResponse.append("      <language>en-gb</language>\n");
            finalResponse.append("      <docs>http://www.rhttp:/ssboard.org/rss-specification</docs>\n");
            finalResponse.append("      <generator>NRF RSS Feed generator</generator>\n");        
            ...
            try
            {
                ...
                ResultSet rs = stm.executeQuery("SELECT * FROM Archive ORDER BY Date desc LIMIT 5;");
