...
COMPONENTS = harvester portal RSS OAI-PMH summary
...
install:
	...
	install -o $(TOMCAT) -v -m 755 installation/Harvest.sh /var/lib/$(TOMCAT)/webapps
	...
	install -o $(TOMCAT) -v -m 644 -d /etc/etdportal
