...
install:
	...
	install -o $(TOMCAT) -v -m 755 installation/Harvest.sh /var/lib/$(TOMCAT)/webapps/union.harvester/
	...
	install -o $(TOMCAT) -v -m 755 -d /etc/etdportal/union
	install -o $(TOMCAT) -v -m 755 -d /var/log/etdportal/union
	install -o $(TOMCAT) -v -m 644 installation/etc_etdportal_config.xml.orig /etc/etdportal/union/config.xml.orig
