...
public class ConfigWriter
{
    ...
    public static boolean saveConfig(HttpServletRequest request)
    {
        ...
        harvestSettings.setProperty("SetSpec", set);
        ...
        try{
            ...
            FileOutputStream out = new FileOutputStream(sett.getSourceDir ()+name+".xml");
    ...
    public static boolean resetDate(String fileName)
    {
        ...
        try
        {
            ...
            FileInputStream harvestSettingsFileStream = new FileInputStream(set.getSourceDir()+fileName);
            ...
            FileOutputStream out = new FileOutputStream(set.getSourceDir()+fileName); // create the file output stream
