...
>
   ...
   <xsl:template match="oai_marc:oai_marc">
      <div class="snippet">
         <span class="snippet_title"><a href="{concat ('?action=view&amp;identifier=', encoder:encode(../../oai:header/oai:identifier))}"><xsl:apply-templates select="oai_marc:varfield[@id='245']"/></a></span>
         <br/>
