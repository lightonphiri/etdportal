...
>
   <xsl:include href="/etc/etdportal/portal/marc_snippet.xsl"/>
   <xsl:include href="/etc/etdportal/portal/etdms_snippet.xsl"/>
   <xsl:include href="/etc/etdportal/portal/rfc1807_snippet.xsl"/>
   <xsl:include href="/etc/etdportal/portal/dc_snippet.xsl"/>
