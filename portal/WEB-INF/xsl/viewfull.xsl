...
>
   ...
   <xsl:include href="/etc/etdportal/portal/marc.xsl"/>
   <xsl:include href="/etc/etdportal/portal/etdms.xsl"/>
   <xsl:include href="/etc/etdportal/portal/rfc1807.xsl"/>
   <xsl:include href="/etc/etdportal/portal/dc.xsl"/>
