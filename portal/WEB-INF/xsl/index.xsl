...
>
   <xsl:include href="/etc/etdportal/portal/marc_index.xsl"/>
   <xsl:include href="/etc/etdportal/portal/etdms_index.xsl"/>
   <xsl:include href="/etc/etdportal/portal/rfc1807_index.xsl"/>
   <xsl:include href="/etc/etdportal/portal/dc_index.xsl"/>
