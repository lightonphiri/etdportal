...
{   
    //database variables
    private static String dbAddress, dbUsername, dbPassword, dbDriver;
    //boolean variable to keep track of whether the config file has been properly read.
    private static boolean configFileError = false;
    //message to display if there is a config error
    private static String configErrorMessage;

    /**
     * auxiliary method to get an Element from an XPath
     */
    public static Element getXMLElement ( Element root, String xpath )
    {
     ...
     */
    public static String getXMLValue ( Element root, String xpath, String defaultValue )
    {
...
//                        finalResponse.append ("<namee>"+new String (rs.getBytes("name"),"UTF-8")+"</namee>");
