...
public class DatabaseUpdater
{
	...
	*/
	public void clearDatabase(Connection con)
	{
		...
		//System.out.println("In DatabaseUpdater");
	    }		 
   ...
   */
       ...
       public void insertRecord (Record record,Connection con)
      {
	    ...
	    Statement stm2 = con.createStatement();
            ...
            if(record != null)
		 {	
		      stm.addBatch("REPLACE INTO RecordTitle VALUES('"+record.getRecordTitle()+"','"+record.getRepositoryIdentifier()+"')" );
		...
		System.out.println(record.toString());
               	sqle.printStackTrace();
		//System.out.println("In DatabaseUpdater insertRecord");
            }
