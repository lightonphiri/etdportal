...
>
   <xsl:include href="/var/lib/tomcat5.5/webapps/ROOT/WEB-INF/config/marc_index.xsl"/>
   <xsl:include href="/var/lib/tomcat5.5/webapps/ROOT/WEB-INF/config/etdms_index.xsl"/>
   <xsl:include href="/var/lib/tomcat5.5/webapps/ROOT/WEB-INF/config/rfc1807_index.xsl"/>
   <xsl:include href="/var/lib/tomcat5.5/webapps/ROOT/WEB-INF/config/dc_index.xsl"/>
