...
xmlns:oai_marc="http://www.openarchives.org/OAI/1.1/oai_marc" xmlns:etdms="http://www.ndltd.org/standards/metadata/etdms/1.0/" 
 xmlns:oai_dc="http://www.openarchives.org/OAI/2.0/oai_dc/"
 xmlns="http://www.w3.org/1999/xhtml" 
 xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
>
    
   <xsl:include href="/var/lib/tomcat5.5/webapps/ROOT/WEB-INF/config/marc.xsl"/>
   <xsl:include href="/var/lib/tomcat5.5/webapps/ROOT/WEB-INF/config/etdms.xsl"/>
   <xsl:include href="/var/lib/tomcat5.5/webapps/ROOT/WEB-INF/config/rfc1807.xsl"/>
   <xsl:include href="/var/lib/tomcat5.5/webapps/ROOT/WEB-INF/config/dc.xsl"/>
